...
import lt.saltyjuice.dragas.chatty.v3.discord.controller.AbstractDiscordConnectionController
...
open class DiscordConnectionController : AbstractDiscordConnectionController()
{
    ...
    companion object
    {
        ...
        @JvmStatic
        val guilds: ConcurrentHashMap<String, CreatedGuild> = ConcurrentHashMap()

        @JvmStatic
        val channels: ConcurrentHashMap<String, Channel> = ConcurrentHashMap()

        @JvmStatic
        val typingMap: ConcurrentHashMap<String, Job> = ConcurrentHashMap()
